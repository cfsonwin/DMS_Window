...
class Region:
    ...
    def GetVX1RegionData_Wcs(self, region_index):
        ...
        points_test_F = np.array(
            [[-0.01172, 0.17179, 0.06841], [-0.008075, 0.002186, 0.01489],
             [1.9482, -0.2208, 0.78077], [1.948, -0.05161, 0.8357]])
    ...
    def GetJ7RegionData(self, region_index):
        ...
        points_test_E = np.array([[-0.4852, 0.2084, 0.2830], [-0.4091, 0.5147, 0.3564], [-0.5961, 0.6147, 0.5863],
                                  [-0.8865, 0.1411, 0.6406]])
        points_test_F = np.array([[-0.01172, 0.17179, 0.06841], [-0.008075, 0.002186, 0.01489], [1.948, -0.05161, 0.8357],
                                  [1.9482, -0.2208, 0.78077]])
        points_test = np.array([points_test_A, points_test_B, points_test_C, points_test_D, points_test_E, points_test_F])
        if region_index == 0:
            test_region = points_test[0]
            v_1 = test_region[0] - test_region[1]
            v_2 = test_region[2] - test_region[1]
